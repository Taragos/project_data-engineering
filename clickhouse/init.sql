...
CREATE TABLE IF NOT EXISTS ig_insights_queue 
(
	id UUID,
	comments UInt64,
	engagement UInt64,
...
CREATE MATERIALIZED VIEW IF NOT EXISTS default.ig_insights_mv TO default.ig_insights AS SELECT id,comments,engagement,impressions,likes,reach,saved,_timestamp FROM `default`.ig_insights_queue;
